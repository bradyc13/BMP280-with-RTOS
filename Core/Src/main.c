...
/* Definitions for de_Pressure */
osThreadId_t de_PressureHandle;
const osThreadAttr_t de_Pressure_attributes = {
  .name = "de_Pressure",
...
/* USER CODE BEGIN Header_pressure_init */
/**
...
{
  /* USER CODE BEGIN 5 */
  /*According to the uxTaskGetStackHighWaterMark Function
   * 672 Bytes (168 words) was allocated for this task by the IDE
   */
  /* Infinite loop */
  for(;;)
  {
...
/* USER CODE BEGIN Header_temperature_init */
/**
...
void temperature_init(void *argument)
{
  /* USER CODE BEGIN temperature_init */
  /* Infinite loop */
  /*
   * According to the uxTaskGetStackHighWaterMark Function
   * This current task uses up 660 Bytes (165 words)
  ...
  /* USER CODE END temperature_init */
}
